...
from xdalgorithm.toolbox.reinvent.utils.logging.tensorboard import add_mols, add_frequent_scaffolds
    ...
    def _visualize_structures(self, smiles):
        ...
        if len(list_of_mols) > 0:
            ...
            add_frequent_scaffolds(writer=self._summary_writer,
                                   ...
                                   mols=list_of_mols[:self._sample_size],
                                   top_frequent=self._rows,
                                   mol_per_row=self._rows)
