...
import xdalgorithm.toolbox.reinvent.utils.logging.log as ull
...
class RemoteReinforcementLogger(BaseReinforcementLogger):
    ...
    def timestep_report(self, start_time, n_steps, step, smiles,
        ...
        scaffold_num = scaffold_num_in_smiles(smiles)
        unique_smiles = unique_smiles_num(smiles)
        ...
        data = self._assemble_timestep_report(step, score_components, structures_table, learning_curves,
                                              time_estimation, valid_fraction,scaffold_num,unique_smiles,smiles_report)
    ...
    def _assemble_timestep_report(self, step, score_components, structures_table, learning_curves, time_estimation,
                                  fraction_valid_smiles, scaffold_num,unique_smiles,smiles_report):
        actual_step = step + 1
        timestep_report = {"step": actual_step,
                           ...
                           "unique_smiles_num":unique_smiles,
                           "smiles_report": smiles_report
                           }
        return timestep_report

    def _visualize_umap_figure(self, smiles_list_dict):
        raise NotImplementedError("the method in remote reinforcement learning logger is not implemented!")
